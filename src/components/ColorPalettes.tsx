...
import { Copy, RefreshCw, Palette, Check, Sparkles, Wand2, ChevronDown, ChevronUp, Bookmark, BookmarkCheck, GitCompare, Circle } from 'lucide-react';
...
const ColorPalettes = () => {
  ...
  // Sample palettes - show 4 by default
  const samplePalettes: ColorPalette[] = [
    ...
    { id: '6', name: 'Mint Fresh', colors: ['#065F46', '#047857', '#059669', '#10B981', '#34D399'], type: 'shades' },
    ...
    { id: '9', name: 'Autumn Leaves', colors: ['#DC2626', '#EA580C', '#F59E0B', '#EAB308', '#84CC16'], type: 'complementary' },
    { id: '10', name: 'Arctic Ice', colors: ['#0F172A', '#334155', '#64748B', '#94A3B8', '#E2E8F0'], type: 'monochrome' },
    { id: '11', name: 'Tropical Paradise', colors: ['#0891B2', '#06B6D4', '#22D3EE', '#67E8F9', '#CFFAFE'], type: 'shades' },
  ...
  return (
    <section id="palettes" className="py-20 px-6 relative" ref={sectionRef}>
      <div className="max-w-7xl mx-auto">
        ...
        {/* Palettes Grid - Show 4 by default */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {displayedPalettes.map((palette, index) => (
            <ParallaxCard key={palette.id} offset={30}>
              <Interactive3DCard>
                <motion.div
                  className="group relative overflow-hidden rounded-xl bg-card/50 backdrop-blur-sm border border-border/50 p-4 hover:shadow-2xl hover:shadow-primary/20 hover:border-primary/30 transition-all duration-500 h-full"
                  {...blurToClear}
